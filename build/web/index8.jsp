...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
    ...
    <body>
        <div class="container">
            <!--/ Codrops top bar -->
            <header>
                <h1>Exploring <span>Knowledge </span></h1>
            </header>
            <section>				
                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            <form  action="login" autocomplete="on" method="post"> 
                                <h1>Log in</h1> 
								<font color="red"><h3 div align=center>Username Or Password Wrong<h3></font>
                                <p> 
                        ...
                        <div id="register" class="animate form">
                            <form  action="Signup" autocomplete="on" method="post"> 
                                <h1> Sign up </h1> 
                                <p> 
                                    <label for="emailsignup" class="youmail" data-icon="e" > Your Username or email</label>
                                    <input id="emailsignup" name="username" required="required" type="text" /> 
                                </p>
                                <p> 
